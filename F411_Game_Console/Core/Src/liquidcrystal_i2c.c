...
void HD44780_Init(uint8_t rows)
{
  ...
  HD44780_CreateSpecialChar(0, Fire_Ball);
  HD44780_CreateSpecialChar(1, nucklear_explotion);
  HD44780_CreateSpecialChar(2, character_move1);
  HD44780_CreateSpecialChar(3, character_move2);
  HD44780_CreateSpecialChar(4, Ground);
  HD44780_CreateSpecialChar(5, BOMB);
